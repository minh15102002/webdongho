        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            <li style="color:#ffff ;"><i style="color:#ffff ;" class="ti-headphone-alt"></i> +84 0909 888 888</li>
                            <li style="color:#ffff ;"><i style="color:#ffff ;" class="ti-email"></i> support@dmtwatch@gmail.com</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                    ...
                    <div class="menu-area">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <div class="navbar-collapse">
                                ...
                                <!-- 1130 -->
                                    <ul class="nav main-menu menu navbar-nav" style="display: flex; align-items: center;justify-content: center; width: 100%;">
                                        <li><a style="color:gray ;" href="index.php">Trang Chủ</a></li>
                                        <li><a style="color:gray ;" href="home.php">Sản Phẩm<i class="ti-angle-down"></i></a>
                                            <ul class="dropdown">
                                                <!-- 536 1098 1159  -->
