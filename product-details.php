...
<body>
            ...
            <div class="col-md-6">
                <div class="product-dtl">
                    ...
                    <div class="product-count">
                        ...
                        <a style="width: 100%;" href="component/add_to_cart_detail.php?id=<?php echo $product['id'] ?>"> <button style="background-color: #f70202;width: 38%;" type="button" class="btn btn-primary" >Thêm vào giỏ hàng</button></a>
    ...
    <p style="font-size: 25px;font-weight: bold;font-family: 'Times New Roman', Times, serif;margin-bottom: 20px;">CÁC SẢN PHẨM KHÁC</p>
    <div class="row">
                <div class="col-12">
                    <div class="product-info">
